...
const ownerNumber = ['94773259828']

//===================SESSION-AUTH============================
if (!fs.existsSync(__dirname + '/sessions/creds.json')) {
if(!config.SESSION_ID) return console.log('Please add your session to SESSION_ID env !!')
const sessdata = config.SESSION_ID.replace("SASI-MD~", '');
...
console.log("CONNECTING 𝑆𝐴𝑆𝐼-𝑀𝐷 🧬...");
...
console.log('𝑆𝐴𝑆𝐼-𝑀𝐷 CONNECTED TO WHATSAPP ENJOY ✅')

let up = `*╭──────────────●●►*
> *➺ 𝑆𝐴𝑆𝐼-𝑀𝐷 ᴄᴏɴɴᴇᴄᴛᴇᴅ sᴜᴄᴄᴇssғᴜʟʏ ᴛʏᴘᴇ .ᴍᴇɴᴜ ᴛᴏ ᴄᴏᴍᴍᴀɴᴅ ʟɪsᴛ ᴄʀᴇᴀᴛᴇᴅ ʙʏ Sathsidu Agresara ✅*
